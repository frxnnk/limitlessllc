...
const FormContainer = styled.div`
  ${tw`p-10 sm:p-12 md:p-16 bg-blue-600 text-white rounded-lg relative`}
  form {
    ${tw`mt-4`}
  }
  h2 {
...
const SubmitButton = tw.button`w-full sm:w-32 mt-6 py-3 bg-gray-100 text-blue-500 rounded-full font-bold tracking-wide shadow-lg uppercase text-sm transition duration-300 transform focus:outline-none focus:shadow-outline hover:bg-gray-300 hover:text-red-700 hocus:-translate-y-px hocus:shadow-xl`;
