...
const FormContainer = styled.div`
  ${tw`p-10 sm:p-12 md:p-16 bg-red-600 text-white rounded-lg relative`}
  form {
    ${tw`mt-4`}
  }
  h2 {
...
const SubmitButton = tw.button`w-full sm:w-32 mt-6 py-3 bg-gray-100 text-red-500 rounded-full font-bold tracking-wide shadow-lg uppercase text-sm transition duration-300 transform focus:outline-none focus:shadow-outline hover:bg-gray-300 hover:text-red-700 hocus:-translate-y-px hocus:shadow-xl`;

const SvgDotPattern1 = tw(SvgDotPatternIcon)`absolute bottom-0 right-0 transform translate-y-1/2 translate-x-1/2 -z-10 opacity-50 text-red-500 fill-current w-24`
