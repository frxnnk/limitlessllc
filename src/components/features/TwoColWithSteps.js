...
const DecoratorBlob = styled(SvgDotPattern)(() => [
  tw`w-20 h-20 absolute right-0 bottom-0 transform translate-x-1/2 translate-y-1/2 fill-current text-teal-500 -z-10`
]);
...
export default ({
  ...
  heading = (
    <>
      Designed & Developed by <span tw="text-teal-500">Professionals.</span>
    </>
  ),
