...
export default ({
  ...
  description = "Simple and Clear Pricing Options for Your Business",
  plans = null,
  ...
  const defaultPlans = [
    {
      ...
      price: ["$299"],
      oldPrice: "$449.99",
      description: "Basic plan is targeted towards individuals and small businesses who require only the basic services of LLC formation.",
      features: ["LLC formation", "EIN",],
    ...
    },
    {
      ...
      price: ["$499"],
      oldPrice: "$699.99",
      description: "Premium plan is for businesses who require more comprehensive services such as LLC formation, bank account opening assistance.",
      features: [
        "LLC formation",
        "EIN",
    ...
    },
    {
      ...
      price: ["$799"],
      oldPrice: "$999.99",
      description: "Advanced plan is ideal for businesses who require a full range of services including LLC formation, bank account opening assistance, custom web design, and ongoing support.",
      features: [
        "LLC formation",
        "EIN",
        "Bank account opening assistance",
        "Simple web for our business"
      ],
      url: "https://google.com"
    }
  ];
